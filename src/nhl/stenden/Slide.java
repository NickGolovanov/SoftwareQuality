...
public class Slide
{
    ...
    protected Vector<SlideItem> slides; // slide items are saved in a Vector

    public Slide()
    {
        this.slides = new Vector<SlideItem>();
    }
    ...
    {
        return (SlideItem) this.slides.elementAt(number);
    }

    // give all SlideItems in a Vector
    public Vector<SlideItem> getSlides()
    {
        return this.slides;
    }
    ...
    public void draw(Graphics g, Rectangle area, ImageObserver view)
    {
        ...
        {
            slideItem = (SlideItem) this.getSlides().elementAt(number);
